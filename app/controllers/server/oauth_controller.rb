...
module Server
  # The OauthController handles OAuth authorization
  class OauthController < ApplicationController # rubocop:disable Metrics/ClassLength
    ...
    def handle_auth_code # rubocop:disable Metrics/AbcSize
      ...
      raise StandardError, 'Invalid client' unless client && auth_code.client_config_id == client.id
    ...
    def handle_refresh_token # rubocop:disable Metrics/AbcSize
      ...
      access_token, refresh_token = generate_tokens(old_refresh_token.user, client, rotate: true)
      render json: {
        access_token: access_token,
        token_type: 'Bearer',
        expires_in: 900,
    ...
    def generate_tokens(user, client, rotate: false) # rubocop:disable Metrics/AbcSize, Metrics/MethodLength
