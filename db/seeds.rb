...
Server::User.find_or_create_by!(first_name: 'test', last_name: 'user', email: 'test.user@gmail.com') do |user|
  user.password = '123456'
end
Server::User.find_or_create_by!(first_name: 'test1', last_name: 'user1', email: 'test.user1@gmail.com') do |user|
  user.password = 'password123'
end
Server::User.find_or_create_by!(first_name: 'test2', last_name: 'user2', email: 'test.user2@gmail.com') do |user|
