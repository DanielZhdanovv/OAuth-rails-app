...
RSpec.describe Server::OauthController, type: :controller do
        ...
        context 'with invalid params' do
          ...
          context "creates authorization code with correct attributes" do
              it "creates authorization code" do
                session[:oauth_params] = valid_params.merge("client_config_id" => client_config.id, "code_challenge" => "code_challenge_12345", "redirect_uri" => client_config.redirect_uri)
                  expect {
                      get :after_login
    ...
    describe "POST #token" do
        ...
        describe "handle_authorization_code" do
        ...
        describe 'handle_refresh_code' do
